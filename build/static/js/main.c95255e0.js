...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__endpoints_json__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__endpoints_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__endpoints_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rootEndpoints_json__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__rootEndpoints_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__rootEndpoints_json__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__getter_js__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__default_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__configurator_js__ = __webpack_require__(109);
...
class Pokedex {
    constructor(config) {
        __WEBPACK_IMPORTED_MODULE_4__configurator_js__["a" /* configurator */].setPokedexConfiguration(config);
        __WEBPACK_IMPORTED_MODULE_4__configurator_js__["a" /* configurator */].setRootEndpointConfiguration(config);
        
        // add to Pokedex.prototype all our endpoint functions
        __WEBPACK_IMPORTED_MODULE_0__endpoints_json___default.a.forEach(endpoint => {
            this[endpoint[0]] = input => { 
                if (input) {

                    // if the user has submitted a Name or an ID, return the JSON promise
                    if (typeof input === 'number' || typeof input === 'string') {
                        return Object(__WEBPACK_IMPORTED_MODULE_2__getter_js__["a" /* loadResource */])(`${__WEBPACK_IMPORTED_MODULE_3__default_js__["a" /* values */].versionPath}${endpoint[1]}/${input}/`); 
                    }
        ...
        __WEBPACK_IMPORTED_MODULE_1__rootEndpoints_json___default.a.forEach(rootEndpoint => {
            this[rootEndpoint[0]] = config => {
                var limit = __WEBPACK_IMPORTED_MODULE_3__default_js__["a" /* values */].limit
                var offset = __WEBPACK_IMPORTED_MODULE_3__default_js__["a" /* values */].offset
                if (config) {
                ...
                return Object(__WEBPACK_IMPORTED_MODULE_2__getter_js__["a" /* loadResource */])(`${__WEBPACK_IMPORTED_MODULE_3__default_js__["a" /* values */].versionPath}${rootEndpoint[1]}?limit=${limit}&offset=${offset}`);
            }
        });
    }
    ...
    resource(path) {
        if (typeof path === 'string') {
            return Object(__WEBPACK_IMPORTED_MODULE_2__getter_js__["a" /* loadResource */])(path)
        } else if (typeof path === 'object') {
            return Promise.all(path.map(p => Object(__WEBPACK_IMPORTED_MODULE_2__getter_js__["a" /* loadResource */])(p)));
        } else {
            return 'String or Array is required'
        }
    }
}
/* harmony export (immutable) */ __webpack_exports__["Pokedex"] = Pokedex;
;

function mapResources(endpoint, input) {
    return input.map(res => {
        return Object(__WEBPACK_IMPORTED_MODULE_2__getter_js__["a" /* loadResource */])(`${__WEBPACK_IMPORTED_MODULE_3__default_js__["a" /* values */].versionPath}${endpoint[1]}/${res}/`);
    });
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Router__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_css_styles_css__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_css_styles_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__styles_css_styles_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__registerServiceWorker__ = __webpack_require__(114);
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_Router__["a" /* default */],null),document.getElementById("root"));Object(__WEBPACK_IMPORTED_MODULE_4__registerServiceWorker__["a" /* default */])();
...
*/
var aa=__webpack_require__(9),ca=__webpack_require__(0),m=__webpack_require__(46),p=__webpack_require__(8),v=__webpack_require__(10),da=__webpack_require__(47),ea=__webpack_require__(48),fa=__webpack_require__(49),ha=__webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Pokemon__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__AllPokemons__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__NotFound__ = __webpack_require__(112);
var Router=function Router(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["a" /* BrowserRouter */],null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Switch */],null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Route */],{exact:true,path:"/",component:__WEBPACK_IMPORTED_MODULE_2__App__["a" /* default */]}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Route */],{path:"/pokemon/:pokemonName",component:__WEBPACK_IMPORTED_MODULE_3__Pokemon__["a" /* default */]}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Route */],{path:"/allpokemons",component:__WEBPACK_IMPORTED_MODULE_4__AllPokemons__["a" /* default */]}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["b" /* Route */],{component:__WEBPACK_IMPORTED_MODULE_5__NotFound__["a" /* default */]})));};/* harmony default export */ __webpack_exports__["a"] = (Router);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tile__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SearchOnePokemonForm__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__SearchMultiplePokemonsForm__ = __webpack_require__(85);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var App=function(_Component){_inherits(App,_Component);function App(){var _ref;var _temp,_this,_ret;_classCallCheck(this,App);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=App.__proto__||Object.getPrototypeOf(App)).call.apply(_ref,[this].concat(args))),_this),_this.state={listedPokemons:[],allPokemons:[],waitingForDataAbout:[]},_this.addItemToWaitingForList=function(name){var waitingForDataAbout=_this.state.waitingForDataAbout;if(waitingForDataAbout.indexOf(name)===-1){waitingForDataAbout.push(name);}_this.setState({waitingForDataAbout:waitingForDataAbout});},_this.removeItemFromWaitingForList=function(name){var waitingForDataAbout=_this.state.waitingForDataAbout;var indexOfItem=waitingForDataAbout.indexOf(name);waitingForDataAbout.splice(indexOfItem,1);_this.setState({waitingForDataAbout:waitingForDataAbout});},_this.fetchItemIntoState=function(name,keepSearches){// Don't make more then 12 requests at one time
// If there is already a request for that item don't send more
if(_this.state.waitingForDataAbout.length>=12||_this.state.waitingForDataAbout.indexOf(name)!==-1){return false;}// Update info about current ajax requests for pokemons
_this.addItemToWaitingForList(name);_this.P.getPokemonByName(name).then(function(result){if(keepSearches===false){_this.setState({listedPokemons:[result]});}else{// 1. Copy current state
var pokemons=_this.state.listedPokemons;// 2. Add pokemon to a state
pokemons.push(result);// 3. Set state
_this.setState({listedPokemons:pokemons});}// Update info about current ajax requests for pokemons
_this.removeItemFromWaitingForList(name);},function(error){_this.removeItemFromWaitingForList(name);alert("Could not find find "+name+" in the database :(");return null;});},_this.redirectToPokemonInfo=function(event){var pokemon=event.props.pokemon.name;_this.props.history.push("/pokemon/"+pokemon);},_this.redirectToAllPokemonsList=function(){_this.props.history.push("/allpokemons");},_this.removePokemons=function(){_this.setState({listedPokemons:[]});},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(App,[{key:"componentDidMount",value:function componentDidMount(){var _this2=this;var Pokedex=__webpack_require__(17);var options={protocol:"http",hostName:"pokeapi.salestock.net",versionPath:"/api/v2/",timeout:120*1000,cache:true};this.P=new Pokedex.Pokedex(options);// Load names of all available pokemons into state
this.P.getPokemonsList().then(function(result){_this2.setState({allPokemons:result.results});},function(eror){console.log("Error downloading list of pokemons, application may not work properly :(");});}},{key:"render",value:function render(){var _this3=this;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"App container mb-5 mt-1 p-3"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button",{className:"green-rounded-box",onClick:this.redirectToAllPokemonsList},"View all pokemons names"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"mx-2"},"Search for specific pokemon by name"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__SearchOnePokemonForm__["a" /* default */],{fetchItemIntoState:this.fetchItemIntoState}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"mx-2 mt-2"},"Search Pokepedia"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__SearchMultiplePokemonsForm__["a" /* default */],{fetchItemIntoState:this.fetchItemIntoState,allPokemons:this.state.allPokemons,removePokemons:this.removePokemons}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"waiting-for-list"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"d-inline-block font-weight-bold mx-2 my-3"},"Waiting for data about:"),Object.keys(this.state.waitingForDataAbout).map(function(key){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{key:key,className:"waiting-for-item green-rounded-box d-inline-block m-1"},_this3.state.waitingForDataAbout[key]);})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",null,"Results"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"pokemons-list"},Object.keys(this.state.listedPokemons).map(function(key){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Tile__["a" /* default */],{key:key,redirectToPokemonInfo:_this3.redirectToPokemonInfo,pokemon:_this3.state.listedPokemons[key]});})));}}]);return App;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (App);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Tile=function(_Component){_inherits(Tile,_Component);function Tile(){_classCallCheck(this,Tile);return _possibleConstructorReturn(this,(Tile.__proto__||Object.getPrototypeOf(Tile)).apply(this,arguments));}_createClass(Tile,[{key:"render",value:function render(){var _this2=this;var name=this.props.pokemon.name;var background=this.props.pokemon.sprites.front_default;var photoCSS={background:"url("+background+")",backgroundSize:"contain"};return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"tile d-inline-block m-2",onClick:function onClick(){_this2.props.redirectToPokemonInfo(_this2);}},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{style:photoCSS}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"font-weight-bold text-center"},name));}}]);return Tile;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (Tile);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var SearchOnePokemonForm=function(_Component){_inherits(SearchOnePokemonForm,_Component);function SearchOnePokemonForm(){var _ref;var _temp,_this,_ret;_classCallCheck(this,SearchOnePokemonForm);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=SearchOnePokemonForm.__proto__||Object.getPrototypeOf(SearchOnePokemonForm)).call.apply(_ref,[this].concat(args))),_this),_this.formInput=__WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef(),_this.keepSearches=__WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef(),_this.searchForSpecificPokemon=function(event){// Stop the form from submitting
event.preventDefault();// Get value from input
var pokemonName=_this.formInput.current.value.toLowerCase();// Check if should keep previous searches
var keepSearches=_this.keepSearches.current.checked;// Fetch Pokemon into state
_this.props.fetchItemIntoState(pokemonName,keepSearches);},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(SearchOnePokemonForm,[{key:"render",value:function render(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("form",{className:"search-one-pokemon-form",onSubmit:this.searchForSpecificPokemon},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input",{type:"text",className:"mx-2 my-1",ref:this.formInput,required:true,placeholder:"Enter name",defaultValue:"bulbasaur",id:"pokemon-name-input"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button",{className:"green-rounded-box mx-2 my-1",type:"submit"},"Find it!"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label",{className:"green-rounded-box chekbox-no-check mx-2 my-1"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input",{type:"checkbox",ref:this.keepSearches,name:"keepSearches",id:"keep-searches"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",null,"Keep previous searches")));}}]);return SearchOnePokemonForm;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (SearchOnePokemonForm);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var SearchMultiplePokemonsForm=function(_Component){_inherits(SearchMultiplePokemonsForm,_Component);function SearchMultiplePokemonsForm(){var _ref;var _temp,_this,_ret;_classCallCheck(this,SearchMultiplePokemonsForm);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=SearchMultiplePokemonsForm.__proto__||Object.getPrototypeOf(SearchMultiplePokemonsForm)).call.apply(_ref,[this].concat(args))),_this),_this.state={maxRangeValue:1,rangeValue:1,startValue:0},_this.rangeStartInput=__WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef(),_this.amountInput=__WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef(),_this.listPokemonsFromScope=function(event){// Prevent default
event.preventDefault();// Check if all pokemons list is available
if(_this.props.allPokemons===undefined){console.log("All pokemons list is not available");return false;}// Get pokemons names from indicated scope
var startValue=+_this.rangeStartInput.current.value,endValue=+startValue+ +_this.amountInput.current.value;var pokemonsFromScope=_this.props.allPokemons.slice(startValue,endValue).map(function(key){return key.name;});// Fetch every pokemon into state
pokemonsFromScope.forEach(function(name){_this.props.fetchItemIntoState(name,true);});},_this.handleChange=function(event){if(event.currentTarget.name==="startValue"){_this.setState({startValue:event.currentTarget.value});}else if(event.currentTarget.name==="rangeValue"){_this.setState({rangeValue:event.currentTarget.value});}},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(SearchMultiplePokemonsForm,[{key:"componentDidUpdate",value:function componentDidUpdate(){if(this.props.allPokemons.length!==0&&this.state.maxRangeValue!==this.props.allPokemons.length){this.setState({maxRangeValue:this.props.allPokemons.length});}}},{key:"render",value:function render(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Fragment,null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("form",{className:"search-pokemons-from-scope-form",onSubmit:this.listPokemonsFromScope},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"font-weight-bold mx-2 my-1"},"Set scope start and range:"," "),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input",{type:"range",className:"range-input",name:"startValue",ref:this.rangeStartInput,min:"0",max:this.state.maxRangeValue,step:"1",defaultValue:"0",onChange:this.handleChange}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"scope-display d-inline-block mx-2 my-1"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",null,this.state.startValue),"-",__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",null,+this.state.startValue+ +this.state.rangeValue))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input",{type:"number",className:"mx-2",name:"rangeValue",ref:this.amountInput,min:"1",max:"12",defaultValue:"1",onChange:this.handleChange}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button",{className:"green-rounded-box mx-2 my-1",type:"submit"},"Search for pokemons")),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button",{className:"green-rounded-box remove-pokemons-btn mx-2 my-2",type:"button",onClick:this.props.removePokemons},"Remove pokemons from the table"));}}]);return SearchMultiplePokemonsForm;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);SearchMultiplePokemonsForm.propTypes={amountInput:__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,rangeStartInput:__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number};/* harmony default export */ __webpack_exports__["a"] = (SearchMultiplePokemonsForm);

/***/ }),
/* 86 */
/***/ (function(module, exports) {

module.exports = [["getBerryByName","berry"],["getBerryFirmnessByName","berry-firmness"],["getBerryFlavorByName","berry-flavor"],["getContestTypeByName","contest-type"],["getContestEffectById","contest-effect"],["getSuperContestEffectById","super-contest-effect"],["getEncounterMethodByName","encounter-method"],["getEncounterConditionByName","encounter-condition"],["getEncounterConditionValueByName","encounter-condition-value"],["getEvolutionChainById","evolution-chain"],["getEvolutionTriggerByName","evolution-trigger"],["getGenerationByName","generation"],["getPokedexByName","pokedex"],["getVersionByName","version"],["getVersionGroupByName","version-group"],["getItemByName","item"],["getItemAttributeByName","item-attribute"],["getItemCategoryByName","item-category"],["getItemFlingEffectByName","item-fling-effect"],["getItemPocketByName","item-pocket"],["getMachineById","machine"],["getMoveByName","move"],["getMoveAilmentByName","move-ailment"],["getMoveBattleStyleByName","move-battle-style"],["getMoveCategoryByName","move-category"],["getMoveDamageClassByName","move-damage-class"],["getMoveLearnMethodByName","move-learn-method"],["getMoveTargetByName","move-target"],["getLocationByName","location"],["getLocationAreaByName","location-area"],["getPalParkAreaByName","pal-park-area"],["getRegionByName","region"],["getAbilityByName","ability"],["getCharacteristicById","characteristic"],["getEggGroupByName","egg-group"],["getGenderByName","gender"],["getGrowthRateByName","growth-rate"],["getNatureByName","nature"],["getPokeathlonStatByName","pokeathlon-stat"],["getPokemonByName","pokemon"],["getPokemonColorByName","pokemon-color"],["getPokemonFormByName","pokemon-form"],["getPokemonHabitatByName","pokemon-habitat"],["getPokemonShapeByName","pokemon-shape"],["getPokemonSpeciesByName","pokemon-species"],["getStatByName","stat"],["getTypeByName","type"],["getLanguageByName","language"]]

/***/ }),
/* 87 */
/***/ (function(module, exports) {

module.exports = [["getEndpointsList",""],["getBerriesList","berry/"],["getBerriesFirmnesssList","berry-firmness/"],["getBerriesFlavorsList","berry-flavor/"],["getContestTypesList","contest-type/"],["getContestEffectsList","contest-effect/"],["getSuperContestEffectsList","super-contest-effect/"],["getEncounterMethodsList","encounter-method/"],["getEncounterConditionsList","encounter-condition/"],["getEncounterConditionValuesList","encounter-condition-value/"],["getEvolutionChainsList","evolution-chain/"],["getEvolutionTriggersList","evolution-trigger/"],["getGenerationsList","generation/"],["getPokedexsList","pokedex/"],["getVersionsList","version/"],["getVersionGroupsList","version-group/"],["getItemsList","item/"],["getItemAttributesList","item-attribute/"],["getItemCategoriesList","item-category/"],["getItemFlingEffectsList","item-fling-effect/"],["getItemPocketsList","item-pocket/"],["getMachinesList","machine/"],["getMovesList","move/"],["getMoveAilmentsList","move-ailment/"],["getMoveBattleStylesList","move-battle-style/"],["getMoveCategoriesList","move-category/"],["getMoveDamageClassesList","move-damage-class/"],["getMoveLearnMethodsList","move-learn-method/"],["getMoveTargetsList","move-target/"],["getLocationsList","location/"],["getLocationAreasList","location-area/"],["getPalParkAreasList","pal-park-area/"],["getRegionsList","region/"],["getAbilitiesList","ability/"],["getCharacteristicsList","characteristic/"],["getEggGroupsList","egg-group/"],["getGendersList","gender/"],["getGrowthRatesList","growth-rate/"],["getNaturesList","nature/"],["getPokeathlonStatsList","pokeathlon-stat/"],["getPokemonsList","pokemon/"],["getPokemonColorsList","pokemon-color/"],["getPokemonFormsList","pokemon-form/"],["getPokemonHabitatsList","pokemon-habitat/"],["getPokemonShapesList","pokemon-shape/"],["getPokemonSpeciesList","pokemon-species/"],["getStatsList","stat/"],["getTypesList","type/"],["getLanguagesList","language/"]]
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return loadResource; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_localforage__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__default_js__ = __webpack_require__(19);
...
function loadResource(url) {
    return new Promise((resolve, reject) => {
        __WEBPACK_IMPORTED_MODULE_1_localforage___default.a.ready()
            .then(() => {
                __WEBPACK_IMPORTED_MODULE_1_localforage___default.a.getItem(`${CACHE_PREFIX}${url}`)
                    .then(value => {
                        if (value === null) {
...
function loadUrl(url) {
    return new Promise((resolve, reject) => {
        let options = {
            baseURL: `${__WEBPACK_IMPORTED_MODULE_2__default_js__["a" /* values */].protocol}://${__WEBPACK_IMPORTED_MODULE_2__default_js__["a" /* values */].hostName}/`,
            timeout: __WEBPACK_IMPORTED_MODULE_2__default_js__["a" /* values */].timeout
        }
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(url, options)
            .then(response => {
                ...
                if (response.status >= 400) {
                    ...
                    if (__WEBPACK_IMPORTED_MODULE_2__default_js__["a" /* values */].cache) {
                        __WEBPACK_IMPORTED_MODULE_1_localforage___default.a.setItem(`${CACHE_PREFIX}${url}`, response.data);
                    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_localforage__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__default_js__ = __webpack_require__(19);
...
configurator.setPokedexConfiguration = (config) => {
    if (config) {
        if (config.hasOwnProperty('protocol')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setProtocol(config.protocol);
        }
        if (config.hasOwnProperty('hostName')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setHostName(config.hostName);
        }
        if (config.hasOwnProperty('versionPath')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setVersionPath(config.versionPath);
        }
        if (config.hasOwnProperty('timeout')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setTimeout(config.timeout);
        }
        if (config.hasOwnProperty('cache')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setCache(config.cache);
        }
    }
}
...
configurator.setRootEndpointConfiguration = (config) => {
	if (config) {
        if (config.hasOwnProperty('offset')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setOffset(config.offset);
        }
        if (config.hasOwnProperty('limit')) {
            __WEBPACK_IMPORTED_MODULE_1__default_js__["a" /* values */].setLimit(config.limit);
        }
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var Pokemon=function(_Component){_inherits(Pokemon,_Component);function Pokemon(){var _ref;var _temp,_this,_ret;_classCallCheck(this,Pokemon);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=Pokemon.__proto__||Object.getPrototypeOf(Pokemon)).call.apply(_ref,[this].concat(args))),_this),_this.state={response:"wait",pokemon:{}},_this.fetchPokemonDataIntoState=function(name){_this.P.getPokemonByName(name).then(function(result){_this.setState({response:"success",pokemon:result});},function(error){_this.setState({response:"error"});});},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Pokemon,[{key:"componentDidMount",value:function componentDidMount(){// 1. Get pokemon's name from props
var name=this.props.match.params.pokemonName;// 2. Set up Pokeapi wrapper
var Pokedex=__webpack_require__(17);var options={protocol:"http",hostName:"pokeapi.salestock.net",versionPath:"/api/v2/",cache:true};this.P=new Pokedex.Pokedex(options);// 3. Fetch Pokemon's data
this.fetchPokemonDataIntoState(name);}},{key:"render",value:function render(){switch(this.state.response){case"wait":return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"request-info p-5 text-center font-weight-bold"},"Downloading pokeData, please wait...");case"error":return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"request-info p-5 text-center font-weight-bold"},"Given pokemon does not exist or API does not respond, sorry :/");case"success":var name=this.state.pokemon.name,background=this.state.pokemon.sprites.front_default,photoCSS={background:"url("+background+")",backgroundSize:"contain"},height=this.state.pokemon.height,weight=this.state.pokemon.weight,base_exp=this.state.pokemon.base_experience,abilities=this.state.pokemon.abilities,types=this.state.pokemon.types.map(function(key){return key.type.name;}).join(", "),stats=this.state.pokemon.stats,moves=this.state.pokemon.moves;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"Pokemon container mb-5 py-3 px-4"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"row"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"col-6 avatar",style:photoCSS}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"col-6 basic-info p-2"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",null,name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,types),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,"Height: ",height),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,"Weight: ",weight),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,"Base experience: ",base_exp),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h3",null,"Abilities"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("ul",null,abilities.map(function(key){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("li",{key:key.ability.name},key.ability.name);}))))),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"stats"},stats.map(function(key){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{key:key.stat.url},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",null,__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{key:key.stat.name},key.stat.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br",null),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{key:key.base_stat},key.base_stat)));})),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",null,"Moves"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"moves p-3"},moves.map(function(key){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{key:key.move.name},key.move.name,", ");})));default:return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"request-info p-5 text-center font-weight-bold"},"Well, that was not expected");}}}]);return Pokemon;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (Pokemon);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var AllPokemons=function(_Component){_inherits(AllPokemons,_Component);function AllPokemons(){var _ref;var _temp,_this,_ret;_classCallCheck(this,AllPokemons);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=AllPokemons.__proto__||Object.getPrototypeOf(AllPokemons)).call.apply(_ref,[this].concat(args))),_this),_this.state={allPokemonsNamesAndUrls:[]},_this.redirectToPokemonInfo=function(event){_this.props.history.push("/pokemon/"+event.target.textContent);},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(AllPokemons,[{key:"componentDidMount",value:function componentDidMount(){var _this2=this;var Pokedex=__webpack_require__(17);var options={protocol:"http",hostName:"pokeapi.salestock.net",versionPath:"/api/v2/",timeout:120*1000,cache:true};this.P=new Pokedex.Pokedex(options);// Load divs - links with pokemons names into state
this.P.getPokemonsList().then(function(result){_this2.setState({allPokemonsNamesAndUrls:result.results});},function(eror){console.log("Error downloading list of pokemons, application may not work properly :(");});}},{key:"render",value:function render(){var _this3=this;return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"all-pokemons-list container mb-5 p-3"},Object.keys(this.state.allPokemonsNamesAndUrls).map(function(key){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"green-rounded-box font-weight-bold d-inline-block m-1",key:key,onClick:_this3.redirectToPokemonInfo},_this3.state.allPokemonsNamesAndUrls[key].name);}));}}]);return AllPokemons;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (AllPokemons);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
var NotFound=function NotFound(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",null,"Item not found :c");};/* harmony default export */ __webpack_exports__["a"] = (NotFound);
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.c95255e0.js.map